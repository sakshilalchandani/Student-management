...
try:
	...
	res = requests.get("https://weather.com/en-IN/weather/today/l/22.08,82.14?par=google&temp=c")
	print(res)
...
#location	
	...
	print(data1text[0])
#temp
	data2 = soup.find('span', {"class" :  "_-_-node_modules-@wxu-components-src-organism-CurrentConditions-CurrentConditions--tempValue--3KcTQ"})
	#print(data2)
	data2text = data2.text
	data2f = data2text + "C"
	print(data2text)
#time
	data3 = soup.find('div', {"class" : "_-_-node_modules-@wxu-components-src-organism-CurrentConditions-CurrentConditions--timestamp--1SWy5"})
...
def asave():
	...
	try:
		...
		print("save issue--->",e)
		showerror("InValid Input !", "Please Check You Have Provided All The Inputs.")
		#aname_e.delete(0, END)
		#arno_e.delete(0, END)
		#amarks_e.delete(0, END)
...
fist = Toplevel(win)
fist.title("Find Students")
fist.geometry("500x500")
fist.config(bg = "yellow")
fist.withdraw()
...
def sel():
	...
	if r ==1:
		...
		msg= "mtech"
	showinfo("i will do", msg)

s= IntVar()
s.set(1)
rbrno = Radiobutton(fist, text = "Find by Roll Number", font = ("arial", 20, "bold"),variable = s, value= 1)
rbname = Radiobutton(fist, text = "Find by Name", font = ("arial", 20, "bold"),variable = s, value= 2)
b1 = Button(fist, text = "Submit", command = sel)
b2 = Button(fist, text = "Back", command = findback)
